...
- Current checkout branch is `kernel-split-workflow-contract-tests`.
...
6. `tests/scripts/test_codex_workflow.py` is smaller and remains focused on cross-subsystem integration and wrapper behavior.
7. Full scripts regression remains green with `139` tests.
